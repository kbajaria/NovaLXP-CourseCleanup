...
class create_course extends external_api {
    ...
    public static function execute(string $brief): array {
        ...
        $result = \local_novalxpcoursefactory\service::create_course($brief);
        if (empty($result['ok'])) {
        ...
        return [
            ...
            'courseurl' => (string)$result['course_url'],
    ...
    public static function execute_returns(): external_single_structure {
        return new external_single_structure([
            ...
            'coursetitle' => new external_value(PARAM_TEXT, 'New course title'),
            'courseurl' => new external_value(PARAM_URL, 'New course URL'),
