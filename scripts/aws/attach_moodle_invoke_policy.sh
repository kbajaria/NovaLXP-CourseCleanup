...
usage() {
  cat <<'EOF'
Usage:
  attach_moodle_invoke_policy.sh --profile PROFILE --role-name ROLE --region REGION --function-name NAME [--policy-name NAME]
EOF
}
...
REGION=""
FUNCTION_NAME=""
POLICY_NAME="NovaLXPCourseFactoryInvokeLambda"
